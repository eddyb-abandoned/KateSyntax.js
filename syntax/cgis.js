KateSyntax.langs.cgis.syntax = {
    default: 'cgis_normal',
    cgis_normal: function cgis_normal(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^[^\S\n]+/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^PROGRAM/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) continue;
            if((m = /^INTERFACE/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) {if(m = this.cgis_interface())return this.pop(), m-1;continue;}
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
    cgis_interface: function cgis_interface(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^[^\S\n]+/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^CONTROL/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) {if(m = this.cgis_control())return this.pop(), m-1;continue;}
            if((m = /^CODE/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) {if(m = this.cgis_code())return this.pop(), m-1;continue;}
            if((m = /^\/\/BEGIN/.exec(this.str)) && this.hl(m[0], 'dsRegionMarker')) {if(m = this.cgis_regionMarker())return this.pop(), m-1;continue;}
            if((m = /^\/\/END/.exec(this.str)) && this.hl(m[0], 'dsRegionMarker')) {if(m = this.cgis_regionMarker())return this.pop(), m-1;continue;}
            ...
            if((m = /^\/\*\s*@\}\s*\*\//.exec(this.str)) && this.hl(m[0], 'dsRegionMarker')) continue;
            if(this.str[0] == '/' && this.str[1] == '/' && this.hl('//', 'dsComment')) {if(m = this.cgis_commentar1())return this.pop(), m-1;continue;}
            if(this.str[0] == '/' && this.str[1] == '*' && this.hl('/*', 'dsComment')) {if(m = this.cgis_commentar2())return this.pop(), m-1;continue;}
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
    cgis_code: function cgis_code(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^[^\S\n]+/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^CONTROL/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) {if(m = this.cgis_control())return this.pop(), m-1;continue;}
            if((m = /^#HINT/.exec(this.str)) && this.hl(m[0], 'dsNormal')) {if(m = this.cgis_hint())return this.pop(), m-1;continue;}
            if((m = /^\/\/BEGIN/.exec(this.str)) && this.hl(m[0], 'dsRegionMarker')) {if(m = this.cgis_regionMarker())return this.pop(), m-1;continue;}
            if((m = /^\/\/END/.exec(this.str)) && this.hl(m[0], 'dsRegionMarker')) {if(m = this.cgis_regionMarker())return this.pop(), m-1;continue;}
            if((m = /^(?:1D|2D|break|continue|do|else|extern|for|forall|foreach|function|if|in|inout|internal|out|reduction|return|struct|typedef|while)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) continue;
            if((m = /^(?:bool|bool2|bool3|bool4|int|int2|int3|int4|half|half2|half3|half4|float|float2|float3|float4)\b/.exec(this.str)) && this.hl(m[0], 'dsDataType')) continue;
    ...
    cgis_control: function cgis_control(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^[^\S\n]+/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^CODE/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) {if(m = this.cgis_code())return this.pop(), m-1;continue;}
    ...
    cgis_common: function cgis_common(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\/\/BEGIN/.exec(this.str)) && this.hl(m[0], 'dsRegionMarker')) {if(m = this.cgis_regionMarker())return this.pop(), m-1;continue;}
            if((m = /^\/\/END/.exec(this.str)) && this.hl(m[0], 'dsRegionMarker')) {if(m = this.cgis_regionMarker())return this.pop(), m-1;continue;}
    ...
    cgis_hint: function cgis_hint(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^[^\S\n]+/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
    ...
    cgis_regionMarker: function cgis_regionMarker(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '\n') return this.pop();
    ...
    cgis_commentar1: function cgis_commentar1(m) {
        this.push();
        while(this.pos < this.len) {
    ...
    cgis_commentar2: function cgis_commentar2(m) {
        this.push();
        while(this.pos < this.len) {
