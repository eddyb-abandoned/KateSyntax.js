KateSyntax.langs.xharbour.syntax = {
    ...
    xharbour_topLevel: function xharbour_topLevel(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^\.and\./i.exec(this.str)) && this.hl(m[0], 'dsBaseN;color:#A01060;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^\.or\./i.exec(this.str)) && this.hl(m[0], 'dsBaseN;color:#A01060;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^\.not\./i.exec(this.str)) && this.hl(m[0], 'dsBaseN;color:#A01060;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^\.f\./i.exec(this.str)) && this.hl(m[0], 'dsBaseN;color:#A01060;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^\.t\./i.exec(this.str)) && this.hl(m[0], 'dsBaseN;color:#A01060;fontStyle:normal;fontWeight:normal')) continue;
            ...
            if(this.str[0] == '-' && this.str[1] == '>' && this.hl('->', 'dsBaseN;color:#A01060;fontStyle:normal;fontWeight:normal')) continue;
    ...
    xharbour_logic: function xharbour_logic(m) {
        ...
        while(this.pos < this.len) {
            ...
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsBaseN;color:#A01060;fontStyle:normal;fontWeight:normal');
        }
        this.pop();
    },
