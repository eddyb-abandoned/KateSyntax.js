...
HL.prototype._normal = function() {
    ...
    while(this.pos < this.len) {
        ...
        if(this.str[0] == '{|' && this.hl('{|', 'dsDecVal')) {this._table();continue;}
        if(this.str[0] == '{{' && this.hl('{{', 'dsDecVal')) {this._template();continue;}
        if(this.str[0] == '[[' && this.hl('[[', 'dsDecVal')) {this._wikiLink();continue;}
