KateSyntax.langs.oors.syntax = {
    default: 'oors_main',
    oors_main: function oors_main(m) {
        this.push();
        while(this.pos < this.len) {
            ...
            if((m = /^\/\*\s*@\}\s*\*\//.exec(this.str)) && this.hl(m[0], 'dsRegionMarker')) continue;
            if(this.str[0] == '/' && this.str[1] == '*' && this.hl('/*', 'dsComment')) {if(m = this.oors_commentStar())return this.pop(), m-1;continue;}
            if(this.str[0] == '/' && this.str[1] == '/' && this.hl('//', 'dsComment')) {if(m = this.oors_commentSlash())return this.pop(), m-1;continue;}
            if((m = /^[^\S\n]+/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if(this.str[0] == '[' && this.hl('[', 'dsNormal')) {if(m = this.oors_ordered())return this.pop(), m-1;continue;}
            if(this.str[0] == '{' && this.hl('{', 'dsNormal')) {if(m = this.oors_unordered())return this.pop(), m-1;continue;}
            if(this.str[0] == '%' && this.str[1] == '{' && this.hl('%{', 'dsBaseN;fontWeight:bold')) {if(m = this.oors_header())return this.pop(), m-1;continue;}
            if(this.str[0] == '%' && this.str[1] == '%' && this.hl('%%', 'dsBaseN;fontWeight:bold')) {if(m = this.oors_header())return this.pop(), m-1;continue;}
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
    oors_header: function oors_header(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\/\/(!|(\/(?=[^/]|(?=$|\n))))<?/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#0000ff;fontStyle:italic')) {if(m = this.doxygen_lineComment())return this.pop(), m-1;continue;}
            if((m = /^\/\*(\*[^*/]|!|[*!]<|\*(?=$|\n))/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#0000ff;fontStyle:italic')) {if(m = this.doxygen_blockComment())return this.pop(), m-1;continue;}
            ...
            if(this.str[0] == '/' && this.str[1] == '*' && this.hl('/*', 'dsComment')) {if(m = this.oors_commentStar())return this.pop(), m-1;continue;}
            if(this.str[0] == '/' && this.str[1] == '/' && this.hl('//', 'dsComment')) {if(m = this.oors_commentSlash())return this.pop(), m-1;continue;}
            if(this.str[0] == '%' && this.str[1] == '}' && this.hl('%}', 'dsBaseN;fontWeight:bold')) return this.pop();
            if(this.str[0] == '%' && this.str[1] == '%' && this.hl('%%', 'dsBaseN;fontWeight:bold')) return this.pop();
            if((m = /^[^\S\n]+/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
    ...
    oors_ordered: function oors_ordered(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^(?:allow|apply|copy|condition|deny|extends|graph|linear|profile|rule|ruleset|search|unsafe)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) continue;
            if((m = /^\/\/(!|(\/(?=[^/]|(?=$|\n))))<?/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#0000ff;fontStyle:italic')) {if(m = this.doxygen_lineComment())return this.pop(), m-1;continue;}
    ...
    oors_unordered: function oors_unordered(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^(?:allow|apply|copy|condition|deny|extends|graph|linear|profile|rule|ruleset|search|unsafe)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) continue;
            if((m = /^\/\/(!|(\/(?=[^/]|(?=$|\n))))<?/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#0000ff;fontStyle:italic')) {if(m = this.doxygen_lineComment())return this.pop(), m-1;continue;}
    ...
    oors_accessor: function oors_accessor(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '$' && this.str[1] == '$' && this.hl('$$', 'dsKeyword')) continue;
            if((m = /^\$-?[_a-zA-Z1-9][_a-zA-Z0-9]*/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) continue;
    ...
    oors_comment: function oors_comment(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\/\/(!|(\/(?=[^/]|(?=$|\n))))<?/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#0000ff;fontStyle:italic')) {if(m = this.doxygen_lineComment())return this.pop(), m-1;continue;}
            if((m = /^\/\*(\*[^*/]|!|[*!]<|\*(?=$|\n))/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#0000ff;fontStyle:italic')) {if(m = this.doxygen_blockComment())return this.pop(), m-1;continue;}
    ...
    oors_commentStar: function oors_commentStar(m) {
        this.push();
        while(this.pos < this.len) {
    ...
    oors_commentSlash: function oors_commentSlash(m) {
        this.push();
        while(this.pos < this.len) {
