KateSyntax.langs.jam.syntax = {
    default: 'jam_normal',
    jam_normal: function jam_normal(m) {
        this.push();
    ...
    jam_block: function jam_block(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_statement: function jam_statement(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_caseCond: function jam_caseCond(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_onPreStment: function jam_onPreStment(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_varAssign: function jam_varAssign(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_assigment: function jam_assigment(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_assigment2: function jam_assigment2(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_subStatement: function jam_subStatement(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_subRule: function jam_subRule(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_actionDefinition: function jam_actionDefinition(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_actionDefinitionFull: function jam_actionDefinitionFull(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_actionDefinitionBind: function jam_actionDefinitionBind(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_actionBody: function jam_actionBody(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^#/.exec(this.str)) && this.hl(m[0], 'dsComment')) {if(m = this.jam_comment())return this.pop(), m-1;continue;}
            if((m = /^$\(/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:blue')) {if(m = this.jam_variable())return this.pop(), m-1;continue;}
    ...
    jam_ruleDefinition: function jam_ruleDefinition(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_ruleDefinitionFull: function jam_ruleDefinitionFull(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_varnameList: function jam_varnameList(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_forStatement: function jam_forStatement(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_forList: function jam_forList(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_ifStatement: function jam_ifStatement(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_preprocess: function jam_preprocess(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\("|\w)/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^##/.exec(this.str)) && this.hl(m[0], 'dsComment;color:darkorange;fontWeight:bold')) {if(m = this.jam_commentTitle())return this.pop(), m-1;continue;}
    ...
    jam_variable: function jam_variable(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^$\(/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:blue')) {if(m = this.jam_variable())return this.pop(), m-1;continue;}
            if((m = /^\)/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:blue')) return this.pop();
            if((m = /^\[/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:blue')) {if(m = this.jam_variableRange())return this.pop(), m-1;continue;}
            if((m = /^:/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:blue')) {if(m = this.jam_variableAttribute())return this.pop(), m-1;continue;}
            if(this.str[0] == '\n') return this.pop(), this.jam_error();
            this.hl(this.str[0], 'dsNormal;color:darkgreen');
        }
        this.pop();
    },
    jam_variableRange: function jam_variableRange(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^$\(/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:blue')) {if(m = this.jam_variable())return this.pop(), m-1;continue;}
            if((m = /^]/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:blue')) return this.pop();
            if(this.str[0] == '\n') return this.pop(), this.jam_error();
            this.hl(this.str[0], 'dsNormal;color:blue');
        }
        this.pop();
    },
    jam_variableAttribute: function jam_variableAttribute(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^$\(/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:blue')) {if(m = this.jam_variable())return this.pop(), m-1;continue;}
            if(/^\)/.exec(this.str)) return this.pop();
    ...
    jam_comment: function jam_comment(m) {
        this.push();
        while(this.pos < this.len) {
    ...
    jam_commentTitle: function jam_commentTitle(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^(FIXME|TODO)/.exec(this.str)) && this.hl(m[0], 'dsAlert')) continue;
            if(this.str[0] == '\n') return this.pop();
    ...
    jam_string: function jam_string(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^$\(/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:blue')) {if(m = this.jam_variable())return this.pop(), m-1;continue;}
    ...
    jam_error: function jam_error(m) {
        this.push();
        while(this.pos < this.len) {
            this.hl(this.str[0], 'dsError');
        }
