KateSyntax.langs.inform.syntax = {
    ...
    inform_topLevel: function inform_topLevel(m) {
        ...
        while(this.pos < this.len) {
            if(this.str[0] == '!' && this.hl('!', 'dsComment;color:#707070;font-style:italic;font-weight:normal')) {if(m = this.inform_comment())return this.pop(), m-1;continue;}
            if(this.str[0] == '"' && this.hl('"', 'dsString;color:#007000;font-style:normal;font-weight:normal')) {if(m = this.inform_string())return this.pop(), m-1;continue;}
            if((m = /^[[]\s*[a-zA-Z_]+\w*/.exec(this.str)) && this.hl(m[0], 'dsFunction')) {if(m = this.inform_funcdef())return this.pop(), m-1;continue;}
            if(this.col === 0 && (m = /^ *object | *class /i.exec(this.str)) && this.hl(m[0], 'dsOthers;color:#109010;font-style:normal;font-weight:bold')) {if(m = this.inform_classDecl())return this.pop(), m-1;continue;}
            if((m = /^(?:Ifdef|Ifndef|Iftrue|Iffalse|Ifnot|Endif|End|Abbreviate|Array|Attribute|Constant|Default|Extend|Global|Ifnot|Iftrue|Iffalse|Import|Include|Link|Lowstring|Message|Property|Release|Replace|Serial|Switches|Statusline|score|System_file|Verb)\b/.exec(this.str)) && this.hl(m[0], 'dsOthers;color:#109010;font-style:normal;font-weight:bold')) continue;
            if((m = /^(?:#ifdef|#else|#ifndef|#endif)\b/.exec(this.str)) && this.hl(m[0], 'dsOthers;color:#109010;font-style:normal;font-weight:bold')) continue;
            ...
            if((m = /^\$[0-9a-fA-F]{1,4}/.exec(this.str)) && this.hl(m[0], 'dsDecVal;color:#5050C0;font-style:normal;font-weight:normal')) continue;
    ...
    inform_normal: function inform_normal(m) {
        ...
        while(this.pos < this.len) {
            if(this.str[0] == '!' && this.hl('!', 'dsComment;color:#707070;font-style:italic;font-weight:normal')) {if(m = this.inform_comment())return this.pop(), m-1;continue;}
            if(this.str[0] == '"' && this.hl('"', 'dsString;color:#007000;font-style:normal;font-weight:normal')) {if(m = this.inform_string())return this.pop(), m-1;continue;}
            if(this.str[0] == '\'' && this.hl('\'', 'dsString;color:#007000;font-style:italic;font-weight:normal')) {if(m = this.inform_word())return this.pop(), m-1;continue;}
            if((m = /^(?:#ifdef|#else|#ifndef|#endif)\b/.exec(this.str)) && this.hl(m[0], 'dsOthers;color:#109010;font-style:normal;font-weight:bold')) continue;
            if((m = /^--?>/.exec(this.str)) && this.hl(m[0], 'dsBaseN;color:#A01060;font-style:normal;font-weight:normal')) continue;
            ...
            if((m = /^(?:String|Routine|bold|roman|underline|fixed|nothing|true|false|on|off|sender|self|location|score|action|actor|noun|second|the_time|consult_from|consult_words|wn|actors_location|buffer|player)\b/.exec(this.str)) && this.hl(m[0], 'dsBaseN;color:#7020F0;font-style:normal;font-weight:bold')) continue;
            if((m = /^(?:has|hasn't|in|notin|provides|ofclass|or)\b/.exec(this.str)) && this.hl(m[0], 'dsBaseN;color:#A01060;font-style:normal;font-weight:normal')) continue;
            if((m = /^##[a-zA-Z_]+\w*/.exec(this.str)) && this.hl(m[0], 'dsDataType;color:#E06060;font-style:normal;font-weight:normal')) continue;
            if((m = /^@[a-zA-Z_]+\w*/.exec(this.str)) && this.hl(m[0], 'dsDecVal;color:#3015F0;font-style:normal;font-weight:bold')) continue;
            if((m = /^\$[0-9a-fA-F]{1,4}/.exec(this.str)) && this.hl(m[0], 'dsDecVal;color:#5050C0;font-style:normal;font-weight:normal')) continue;
    ...
    inform_classDecl_1: function inform_classDecl_1(m) {
        ...
        while(this.pos < this.len) {
            ...
            if(this.str[0] == ';' && this.hl(';', 'dsOthers;color:#109010;font-style:normal;font-weight:bold')) return this.pop();
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
    inform_word: function inform_word(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '\'' && this.hl('\'', 'dsString;color:#007000;font-style:italic;font-weight:normal')) return this.pop();
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsString;color:#007000;font-style:italic;font-weight:normal');
        }
        this.pop();
    },
    inform_string: function inform_string(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '"' && this.hl('"', 'dsString;color:#007000;font-style:normal;font-weight:normal')) return this.pop();
            this.hl(this.str[0], 'dsString;color:#007000;font-style:normal;font-weight:normal');
        }
        this.pop();
    },
    ...
    inform_prop_def: function inform_prop_def(m) {
        ...
        while(this.pos < this.len) {
            if(this.str[0] == ',' && this.hl(',', 'dsFunction')) return this.pop();
            if(this.str[0] == ';' && this.hl(';', 'dsOthers;color:#109010;font-style:normal;font-weight:bold')) return this.pop(), 2;
            if(this.str[0] == '[' && this.hl('[', 'dsFunction')) {if(m = this.inform_prop_func_def())return this.pop(), m-1;continue;}
            if(this.str[0] == '!' && this.hl('!', 'dsComment;color:#707070;font-style:italic;font-weight:normal')) {if(m = this.inform_comment())return this.pop(), m-1;continue;}
            if(this.str[0] == '"' && this.hl('"', 'dsString;color:#007000;font-style:normal;font-weight:normal')) {if(m = this.inform_string())return this.pop(), m-1;continue;}
            if(this.str[0] == '\'' && this.hl('\'', 'dsString;color:#007000;font-style:italic;font-weight:normal')) {if(m = this.inform_word())return this.pop(), m-1;continue;}
    ...
    inform_comment: function inform_comment(m) {
        ...
        while(this.pos < this.len) {
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsComment;color:#707070;font-style:italic;font-weight:normal');
        }
        this.pop();
    }
};
