KateSyntax.langs.nasm.syntax = {
    default: 'nasm_normal',
    nasm_normal: function nasm_normal(m) {
        this.push();
        while(this.pos < this.len) {
            ...
            if(this.str[0] == ';' && this.hl(';', 'dsComment')) {if(m = this.nasm_comment())return this.pop(), m-1;continue;}
            if(this.str[0] == '%' && this.hl('%', 'dsOthers')) {if(m = this.nasm_preprocessor())return this.pop(), m-1;continue;}
            if((m = /^["']/.exec(this.str)) && this.hl(m[0], 'dsString')) {if(m = this.nasm_string())return this.pop(), m-1;continue;}
    ...
    nasm_comment: function nasm_comment(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '\n') return this.pop();
    ...
    nasm_preprocessor: function nasm_preprocessor(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '\n') return this.pop();
    ...
    nasm_string: function nasm_string(m) {
        this.push();
        while(this.pos < this.len) {
