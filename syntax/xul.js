KateSyntax.langs.xul.syntax = {
    ...
    xul_start: function xul_start(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^<!\[CDATA\[/.exec(this.str)) && this.hl(m[0], 'dsBaseN;font-weight:bold')) {if(m = this.xul_cDATA())return this.pop(), m-1;continue;}
            if((m = /^<!DOCTYPE\s+/.exec(this.str)) && this.hl(m[0], 'dsDataType;font-weight:bold')) {if(m = this.xul_doctype())return this.pop(), m-1;continue;}
    ...
    xul_doctype: function xul_doctype(m) {
        ...
        while(this.pos < this.len) {
            ...
            if(this.str[0] == '[' && this.hl('[', 'dsDataType;font-weight:bold')) {if(m = this.xul_doctypeInternalSubset())return this.pop(), m-1;continue;}
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
    xul_doctypeInternalSubset: function xul_doctypeInternalSubset(m) {
        ...
        while(this.pos < this.len) {
            if(this.str[0] == ']' && this.hl(']', 'dsDataType;font-weight:bold')) return this.pop();
            if((m = /^<!(ELEMENT|ENTITY|ATTLIST|NOTATION)\b/.exec(this.str)) && this.hl(m[0], 'dsDataType;font-weight:bold')) {if(m = this.xul_doctypeMarkupdecl())return this.pop(), m-1;continue;}
            if((m = /^<!--/.exec(this.str)) && this.hl(m[0], 'dsComment')) {if(m = this.xul_comment())return this.pop(), m-1;continue;}
            if((m = /^<\?[\w:_-]*/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) {if(m = this.xul_pI())return this.pop(), m-1;continue;}
            if((m = /^&entref;/.exec(this.str)) && this.hl(m[0], 'dsDecVal')) continue;
            if((m = /^%&name;;/.exec(this.str)) && this.hl(m[0], 'dsDecVal')) continue;
    ...
    xul_cDATA: function xul_cDATA(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^(?:Anchor|Applet|Area|Array|Boolean|Button|Checkbox|Date|document|window|Image|FileUpload|Form|Frame|Function|Hidden|Link|MimeType|Math|Max|Min|Layer|navigator|Object|Password|Plugin|Radio|RegExp|Reset|Screen|Select|String|Text|Textarea|this|Window)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#008000;font-style:normal;font-weight:normal')) continue;
            if((m = /^(?:abs|acos|asin|atan|atan2|ceil|cos|ctg|E|exp|floor|LN2|LN10|log|LOG2E|LOG10E|PI|pow|round|sin|sqrt|SQRT1_2|SQRT2|tan)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#DBA716;font-style:normal;font-weight:normal')) continue;
            if((m = /^(?:onAbort|onBlur|onChange|onClick|onError|onFocus|onLoad|onMouseOut|onMouseOver|onReset|onSelect|onSubmit|onUnload)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#F766D5;font-style:normal;font-weight:normal')) continue;
