KateSyntax.langs.ldif.syntax = {
    ...
    ldif_ctxStart: function ldif_ctxStart(m) {
        ...
        while(this.pos < this.len) {
            if((m = /^#.*(?=$|\n)/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#808080;fontStyle:normal;fontWeight:normal')) continue;
            if(this.str[0] == ':' && this.hl(':', 'dsKeyword;color:#000000;fontStyle:normal;fontWeight:bold')) {if(m = this.ldif_ctxEncoded())return this.pop(), m-1;continue;}
            if(this.str[0] == '<' && this.hl('<', 'dsKeyword;color:#000000;fontStyle:normal;fontWeight:bold')) {if(m = this.ldif_ctxURL())return this.pop(), m-1;continue;}
            if((m = /^[^:<]/.exec(this.str)) && this.hl(m[0], 'dsString;color:#008000;fontStyle:normal;fontWeight:normal')) {if(m = this.ldif_ctxStandard())return this.pop(), m-1;continue;}
            if(this.col === 0 && (m = /^[\w\-]+((;[\w\-]+)+)?:/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000000;fontStyle:normal;fontWeight:bold')) continue;
            this.hl(this.str[0], 'dsString;color:#008000;fontStyle:normal;fontWeight:normal');
        }
        this.pop();
    },
    ldif_ctxEncoded: function ldif_ctxEncoded(m) {
        ...
        while(this.pos < this.len) {
            if((m = /^#.*(?=$|\n)/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#808080;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^\s.*(?=$|\n)/.exec(this.str)) && this.hl(m[0], 'dsString;color:#FF8000;fontStyle:normal;fontWeight:normal')) continue;
            if(this.col === 0 && (m = /^[\w\-]+((;[\w\-]+)+)?:/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000000;fontStyle:normal;fontWeight:bold')) return this.pop();
            this.hl(this.str[0], 'dsString;color:#FF8000;fontStyle:normal;fontWeight:normal');
        }
        this.pop();
    },
    ldif_ctxURL: function ldif_ctxURL(m) {
        ...
        while(this.pos < this.len) {
            if((m = /^#.*(?=$|\n)/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#808080;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^\s+[\w]+:\/\/[\w/.]+/.exec(this.str)) && this.hl(m[0], 'dsString;color:#0000FF;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^\s.*(?=$|\n)/.exec(this.str)) && this.hl(m[0], 'dsString;color:#0000FF;fontStyle:normal;fontWeight:normal')) continue;
            if(this.col === 0 && (m = /^[\w\-]+((;[\w\-]+)+)?:/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000000;fontStyle:normal;fontWeight:bold')) return this.pop();
            this.hl(this.str[0], 'dsString;color:#0000FF;fontStyle:normal;fontWeight:normal');
        }
        this.pop();
    },
    ...
    ldif_ctxEncrypted: function ldif_ctxEncrypted(m) {
        ...
        while(this.pos < this.len) {
            ...
            if(this.col === 0 && (m = /^[\w\-]+((;[\w\-]+)+)?:/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000000;fontStyle:normal;fontWeight:bold')) return this.pop(), 1;
