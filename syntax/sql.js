KateSyntax.langs.sql.syntax = {
    ...
    sql_normal: function sql_normal(m) {
        ...
        while(this.pos < this.len) {
            ...
            if(this.str[0] == '\'' && this.hl('\'', 'dsString')) {if(m = this.sql_stringLiteral())return this.pop(), m-1;continue;}
            if(this.str[0] == '-' && this.str[1] == '-' && this.hl('--', 'dsComment')) {if(m = this.sql_singlelinePLSQLStyleComment())return this.pop(), m-1;continue;}
            if(this.str[0] == '/' && this.str[1] == '*' && this.hl('/*', 'dsComment')) {if(m = this.sql_multilineCStyleComment())return this.pop(), m-1;continue;}
            if(this.col === 0 && (m = /^rem\b/i.exec(this.str)) && this.hl(m[0], 'dsComment')) {if(m = this.sql_sQLPlusRemarkDirective())return this.pop(), m-1;continue;}
            if(this.str[0] == '"' && this.hl('"', 'dsOthers')) {if(m = this.sql_userDefinedIdentifier())return this.pop(), m-1;continue;}
            if((m = /^(:|&&?)\w+/.exec(this.str)) && this.hl(m[0], 'dsChar')) continue;
            if(this.col === 0 && (m = /^\/(?=$|\n)/.exec(this.str)) && this.hl(m[0], 'dsChar')) continue;
            if(this.col === 0 && (m = /^@@?[^@ \t\r\n]/.exec(this.str)) && this.hl(m[0], 'dsOthers')) {if(m = this.sql_sQLPlusDirectiveToIncludeFile())return this.pop(), m-1;continue;}
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
    sql_stringLiteral: function sql_stringLiteral(m) {
        this.push();
        while(this.pos < this.len) {
    ...
    sql_singlelinePLSQLStyleComment: function sql_singlelinePLSQLStyleComment(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '\n') return this.pop();
    ...
    sql_multilineCStyleComment: function sql_multilineCStyleComment(m) {
        this.push();
        while(this.pos < this.len) {
    ...
    sql_sQLPlusRemarkDirective: function sql_sQLPlusRemarkDirective(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsComment');
    ...
    sql_userDefinedIdentifier: function sql_userDefinedIdentifier(m) {
        this.push();
        while(this.pos < this.len) {
    ...
    sql_sQLPlusDirectiveToIncludeFile: function sql_sQLPlusDirectiveToIncludeFile(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsOthers');
