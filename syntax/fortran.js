KateSyntax.langs.fortran.syntax = {
    ...
    fortran_default: function fortran_default(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^(?:abs|cabs|dabs|iabs|aimag|aint|dint|anint|dnint|ceiling|cmplx|dcmplx|dimag|floor|nint|idnint|int|idint|ifix|real|float|sngl|dble|dreal|aprime|dconjg|dfloat|ddmim|rand|modulo|conjg|dprod|dim|ddim|idim|max|amax0|amax1|max0|max1|dmax1|min|amin0|amin1|min0|min1|dmin1|mod|amod|dmod|sign|dsign|isign|acos|dacos|asin|dasin|atan|datan|atan2|datan2|cos|ccos|dcos|cosh|dcosh|exp|cexp|dexp|log|alog|dlog|clog|log10|alog10|dlog10|sin|csin|dsin|sinh|dsinh|sqrt|csqrt|dsqrt|tan|dtan|tanh|dtanh|achar|char|iachar|ichar|lge|lgt|lle|llt|adjustl|adjustr|index|len_trim|scan|verify|logical|exponent|fraction|nearest|rrspacing|scale|set_exponent|spacing|btest|iand|ibclr|ibits|ibset|ieor|ior|ishft|ishftc|not|mvbits|merge)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#600060;fontStyle:normal;fontWeight:bold')) continue;
            if((m = /^(?:associated|present|kind|len|digits|epsilon|huge|maxexponent|minexponent|precision|radix|range|tiny|bit_size|allocated|lbound|ubound|shape|size)\b/.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#000060;fontStyle:italic;fontWeight:bold')) continue;
            if((m = /^(?:repeat|trim|selected_int_kind|selected_real_kind|transfer|dot_product|matmul|all|any|count|maxval|minval|product|sum|pack|unpack|reshape|spread|cshift|eoshift|transpose|maxloc|minloc)\b/.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#600060;fontStyle:normal;fontWeight:bold')) continue;
            if((m = /^(?:date_and_time|system_clock|random_number|random_seed)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#600060;fontStyle:normal;fontWeight:bold')) continue;
            if((m = /^\b(read|write|backspace|rewind|end\s*file|close)\s*[(]/i.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) {if(m = this.fortran_find_io_paren())return this.pop(), m-1;continue;}
            if((m = /^\bopen\s*[(]/i.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) {if(m = this.fortran_find_io_paren())return this.pop(), m-1;continue;}
            if((m = /^\binquire\s*[(]/i.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) {if(m = this.fortran_find_io_paren())return this.pop(), m-1;continue;}
            if((m = /^\bformat\s*[(]/i.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) {if(m = this.fortran_format_stmnt())return this.pop(), m-1;continue;}
            if((m = /^\bend\s*file\b/i.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^(?:access|backspace|close|inquire|open|print|read|rewind|write|format)\b/.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^\.(true|false)\./i.exec(this.str)) && this.hl(m[0], 'dsOthers;color:#800080;fontStyle:normal;fontWeight:bold')) continue;
            if((m = /^\.[A-Za-z]+\./.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#008000;fontStyle:normal;fontWeight:bold')) continue;
            if((m = /^(==|\/=|<|<=|>|>=)/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#008000;fontStyle:normal;fontWeight:bold')) continue;
    ...
    fortran_find_io_paren: function fortran_find_io_paren(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '*' && this.hl('*', 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) continue;
            if(this.str[0] == '(' && this.hl('(', 'dsNormal')) {if(m = this.fortran_inside_func_paren())return this.pop(), m-1;continue;}
            if(this.str[0] == ')' && this.hl(')', 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) return this.pop();
            if((m = /^(?:unit|end|err|fmt|iostat|status|advance|size|eor)\b/.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^(?:unit|iostat|err|file|exist|opened|number|named|name|access|sequential|direct|form|formatted|unformatted|recl|nextrec|blank|position|action|read|write|readwrite|delim|pad)\b/.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^(?:unit|iostat|err|file|status|access|form|recl|blank|position|action|delim|pad)\b/.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) continue;
            if(this.str[0] == '\'' && this.hl('\'', 'dsString')) {if(m = this.fortran_string_1())return this.pop(), m-1;continue;}
            if(this.str[0] == '"' && this.hl('"', 'dsString')) {if(m = this.fortran_string_2())return this.pop(), m-1;continue;}
            if((m = /^(?:allocate|break|call|case|common|continue|cycle|deallocate|default|forall|where|elsewhere|equivalence|exit|external|for|go|goto|if|implicit|include|interface|intrinsic|namelist|none|nullify|operator|assignment|pause|procedure|pure|elemental|record|recursive|result|return|select|selectcase|stop|to|use|only|entry|while)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) continue;
            if((m = /^(?:abs|cabs|dabs|iabs|aimag|aint|dint|anint|dnint|ceiling|cmplx|dcmplx|dimag|floor|nint|idnint|int|idint|ifix|real|float|sngl|dble|dreal|aprime|dconjg|dfloat|ddmim|rand|modulo|conjg|dprod|dim|ddim|idim|max|amax0|amax1|max0|max1|dmax1|min|amin0|amin1|min0|min1|dmin1|mod|amod|dmod|sign|dsign|isign|acos|dacos|asin|dasin|atan|datan|atan2|datan2|cos|ccos|dcos|cosh|dcosh|exp|cexp|dexp|log|alog|dlog|clog|log10|alog10|dlog10|sin|csin|dsin|sinh|dsinh|sqrt|csqrt|dsqrt|tan|dtan|tanh|dtanh|achar|char|iachar|ichar|lge|lgt|lle|llt|adjustl|adjustr|index|len_trim|scan|verify|logical|exponent|fraction|nearest|rrspacing|scale|set_exponent|spacing|btest|iand|ibclr|ibits|ibset|ieor|ior|ishft|ishftc|not|mvbits|merge)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#600060;fontStyle:normal;fontWeight:bold')) continue;
    ...
    fortran_format_stmnt: function fortran_format_stmnt(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '(' && this.hl('(', 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) {if(m = this.fortran_format_stmnt())return this.pop(), m-1;continue;}
            if(this.str[0] == ')' && this.hl(')', 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) return this.pop();
            if((m = /^[0-9]*\//i.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^[:]/.exec(this.str)) && this.hl(m[0], 'dsFunction;color:#006060;fontStyle:normal;fontWeight:normal')) continue;
            if(this.str[0] == '\'' && this.hl('\'', 'dsString')) {if(m = this.fortran_string_1())return this.pop(), m-1;continue;}
            if(this.str[0] == '"' && this.hl('"', 'dsString')) {if(m = this.fortran_string_2())return this.pop(), m-1;continue;}
            if(this.str[0] == '*' && this.str[1] == '*' && this.hl('**', 'dsKeyword')) continue;
            if(this.str[0] == '(' && this.str[1] == '/' && this.hl('(/', 'dsKeyword')) continue;
