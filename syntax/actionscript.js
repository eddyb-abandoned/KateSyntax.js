KateSyntax.langs.actionscript.syntax = {
    ...
    actionscript_normal: function actionscript_normal(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^(?:false|Infinity|-Infinity|NaN|newline|null|true|undefined)\b/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#003300;fontStyle:normal;fontWeight:bold')) continue;
    ...
    actionscript_staticImports: function actionscript_staticImports(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\s*.*(?=$|\n)/.exec(this.str)) && m[0].length && this.hl(m[0], 'dsKeyword;color:#800080;fontStyle:normal;fontWeight:normal')) return this.pop();
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    ...
    actionscript_imports: function actionscript_imports(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\s*.*(?=$|\n)/.exec(this.str)) && m[0].length && this.hl(m[0], 'dsKeyword;color:#808000;fontStyle:normal;fontWeight:normal')) return this.pop();
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
