KateSyntax.langs.lex.syntax = {
    ...
    lex_definitions: function lex_definitions(m) {
        ...
        while(this.pos < this.len) {
            ...
            if(this.col === 0 && this.str[0] == '%' && this.str[1] == '{' && this.hl('%{', 'dsBaseN;fontWeight:bold')) {if(m = this.lex_lexCBloc())return this.pop(), m-1;continue;}
            if(this.str[0] == '%' && this.str[1] == '%' && this.hl('%%', 'dsBaseN;fontWeight:bold')) {if(m = this.lex_rules())return this.pop(), m-1;continue;}
    ...
    lex_rules: function lex_rules(m) {
        ...
        while(this.pos < this.len) {
            if((m = /^\s/.exec(this.str)) && this.hl(m[0], 'dsNormal')) {if(m = this.lex_indentedC())return this.pop(), m-1;continue;}
            if(this.col === 0 && this.str[0] == '%' && this.str[1] == '{' && this.hl('%{', 'dsBaseN;fontWeight:bold')) {if(m = this.lex_lexCBloc())return this.pop(), m-1;continue;}
            if(this.str[0] == '%' && this.str[1] == '%' && this.hl('%%', 'dsBaseN;fontWeight:bold')) {if(m = this.lex_userCode())return this.pop(), m-1;continue;}
    ...
    lex_ruleRegExpr: function lex_ruleRegExpr(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\{(?=$|\n)/.exec(this.str)) && this.hl(m[0], 'dsBaseN;fontWeight:bold')) {if(m = this.lex_startConditionsScope())return this.pop(), m-1;continue;}
            if((m = /^\\./.exec(this.str)) && this.hl(m[0], 'dsString;fontWeight:bold')) continue;
            if(this.str[0] == '(' && this.hl('(', 'dsString')) {if(m = this['lex_regExpr (']())return this.pop(), m-1;continue;}
            if(this.str[0] == '[' && this.hl('[', 'dsString')) {if(m = this['lex_regExpr [']())return this.pop(), m-1;continue;}
            if(this.str[0] == '{' && this.hl('{', 'dsString')) {if(m = this['lex_regExpr {']())return this.pop(), m-1;continue;}
    ...
    lex_startConditionsScope: function lex_startConditionsScope(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\s*\}/.exec(this.str)) && this.hl(m[0], 'dsBaseN;fontWeight:bold')) return this.pop();
    ...
    lex_action: function lex_action(m) {
        ...
        while(this.pos < this.len) {
            ...
            if(this.str[0] == '%' && this.str[1] == '{' && this.hl('%{', 'dsBaseN;fontWeight:bold')) {if(m = this.lex_lexRuleCBloc())return this.pop(), m-1;continue;}
            if(this.str[0] == '\n') return this.pop();
