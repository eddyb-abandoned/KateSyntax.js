KateSyntax.langs.rsiidl.syntax = {
    ...
    rsiidl_normal: function rsiidl_normal(m) {
        ...
        while(this.pos < this.len) {
            if((m = /^(?:For|Do|Endfor|Repeat|Endrep|While|Endwhile|Until|Case|Endcase|If|Endif|Else|Endelse|Then|Begin|End|Function|Goto|Pro|Eq|Ge|Gt|Le|Lt|Ne|Mod|Or|Xor|Not|And|Then|Return|Common|Of|On_ioerror|Switch|Endswitch)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#1414e4;fontWeight:bold')) continue;
