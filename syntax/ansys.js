...
HL.prototype._normalText = function() {
    ...
    while(this.pos < this.len) {
        if((m = /^C\*\*\*/i.exec(this.str)) && this.hl(m[0], 'dsComment')) {this._comment();continue;}
        if(this.str[0] == '!' && this.hl('!', 'dsComment')) {this._comment();continue;}
        if((m = /^(?:NX|NY|NZ)\b/.exec(this.str)) && this.hl(m[0], 'dsDataType')) continue;
        ...
        if((m = /^(?:LINK1|PLANE2|BEAM3|BEAM4|SOLID5|COMBIN7|LINK8|INFIN9|LINK10|LINK11|CONTAC12|PLANE13|COMBIN14|PIPE16|PIPE17|PIPE18|PIPE20|MASS21|BEAM23|BEAM24|PLANE25|MATRIX27|SHELL28|FLUID29|FLUID30|LINK31|LINK32|LINK33|LINK34|PLANE35|SOURC36|COMBIN37|FLUID38|COMBIN39|COMBIN40|SHELL41|PLANE42|SHELL43|BEAM44|SOLID45|SOLID46|INFIN47|MATRIX50|SHELL51|CONTAC52|PLANE53|BEAM54|PLANE55|HYPER56|SHELL57|HYPER58|PIPE59|PIPE60|SHELL61|SOLID62|SHELL63|SOLID64|SOLID65|PLANE67|LINK68|SOLID69|SOLID70|MASS71|HYPER74|PLANE75|PLANE77|PLANE78|FLUID79|FLUID80|FLUID81|PLANE82|PLANE83|HYPER84|HYPER86|SOLID87|VISCO88|VISCO89|SOLID90|SHELL91|SOLID92|SHELL93|CIRCU94|SOLID95|SOLID96|SOLID97|SOLID98|SHELL99|VISCO106|VISCO107|VISCO108|TRANS109|INFIN110|INFIN111|INTER115|FLUID116|SOLID117|HF118|HF119|HF120|PLANE121|SOLID122|SOLID123|CIRCU124|CIRCU125|TRANS126|SOLID127|SOLID128|FLUID129|FLUID130|SHELL131|SHELL132|FLUID136|FLUID138|FLUID139|FLUID141|FLUID142|SHELL143|ROM144|PLANE145|PLANE146|SOLID147|SOLID148|SHELL150|SURF151|SURF152|SURF153|SURF154|SHELL157|HYPER158|LINK160|BEAM161|PLANE162|SHELL163|SOLID164|COMBI165|MASS166|LINK167|SOLID168|TARGE169|TARGE170|CONTA171|CONTA172|CONTA173|CONTA174|CONTA175|CONTA178|PRETS179|LINK180|SHELL181|PLANE182|PLANE183|MPC184|SOLID185|SOLID186|SOLID187|BEAM188|BEAM189|SOLSH190|SOLID191|INTER192|INTER193|INTER194|INTER195|MESH200|FOLLW201|SHELL208|SHELL209|PLANE223|SOLID226|SOLID227|PLANE230|SOLID231|SOLID232|SURF251|SURF252)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) continue;
        if((m = /^(?:EX|EY|EZ|GXY|NUXY|ALPX|ALPY|ALPZ|CTEX|CTEY|CTEZ|THSX|THSY|THSZ|REFT|PRXY|PRYZ|PRXZ|NUXY|NUYZ|NUXZ|GXY|GYZ|GXZ|DAMP|DMPR|MU|DENS|C|ENTH|KXX|KYY|KZZ|HF|EMIS|QRATE|VISC|SONC|RSVX|RSVY|RSVZ|PERX|MURX|MURY|MURZ|MGXX|MGYY|MGZZ|LSST|SBKX)\b/.exec(this.str)) && this.hl(m[0], 'dsDataType')) continue;
        if((m = /^(?:UX|UY|UZ|FX|FY|FZ|MX|MY|MZ|HEAT|HBOT|HE2|HE3|HTOP|FLOW|AMPS|CHRG|CSGX|CSGY|CSGZ|ROTX|ROTY|ROTZ|WARP|TEMP|TBOT|TE2|TE3|TTOP|PRES|VX|VY|VZ|ENKE|ENDS|SP01|SP02|SP03|SP04|SP05|SP06|VOLT|MAG|AX|AYAZ)\b/.exec(this.str)) && this.hl(m[0], 'dsChar')) continue;
        if((m = /^(?:STATIC|BUCKLE|MODAL|HARMIC|TRANS|SUBSTR|SPECTR)\b/.exec(this.str)) && this.hl(m[0], 'dsChar')) continue;
        if((m = /^(?:ABS|SIGN|EXP|LOG|LOG10|SQRT|NINT|MOD|RAND|GDIS|SIN|COS|TAN|SINH|COSH|TANH|ASIN|ACOS|ATAN|ATAN2|VALCHR|CHRVAL|UPCASE|LWCASE)\b/.exec(this.str)) && this.hl(m[0], 'dsOthers')) continue;
        if((m = /^(?:\/BATCH|\/CONFIG|\/CWD|\/EOF|\/EXIT|\/FILNAME|HELP|\/INPUT|KEYW|MEMM|\/MENU|\/MSTART|\/NERR|\/OUTPUT|\/STATUS|\/SYP|\/SYS|\/UI|\/UIS|\/AUX2|\/AUX3|\/AUX12|\/AUX15|FINISH|\/OPT|\/POST1|\/POST26|\/PREP7|\/QUIT|\/RUNST|\/SOLU|\/ASSIGN|\/CLOG|\/COPY|\/DELETE|\/FDELE|\/FTYPE|LGWRITE|\*LIST|\/RENAME|\/COM|\/GO|\/GOLIST|\/GOPR|\/NOLIST|\/NOPR)\b/.exec(this.str)) && this.hl(m[0], 'dsFunction')) continue;
        if((m = /^(?:\/CLEAR|RESUME|SAVE|\/SMBC|STAT|\/STITLE|\/TITLE|UNDO|\/UNITS|ALLSEL|ASLL|ASEL|ASLV|DOFSEL|ESEL|ESLA|ESLL|ESLN|ESLV|KSEL|KSLL|KSLN|LSEL|LSLA|LSLK|NSEL|NSLA|NSLE|NSLK|NSLL|NSLV|PARTSEL|VSEL|VSLA|CM|CMDELE|CMEDIT|CMGRP|CMLIST|CMMOD|CMPLOT|CMSEL|KWPAVE|KWPLAN|LWPLAN|NWPAVE|NWPLAN|WPAVE|WPCSYS|WPLANE|WPOFFS|WPROTA|WPSTYL|CLOCAL|CS|CSCIR|CSDELE|CSKP|CSLIST|CSWPLA|CSYS|LOCAL|FITEM|FLST)\b/.exec(this.str)) && this.hl(m[0], 'dsFunction')) continue;
        if((m = /^(?:\/CMAP|\/COLOR|\/DEVICE|DSYS|\/DV3D|\/ERASE|ERASE|\/GCMD|\/GCOLUMN|\/GFILE|GPLOT|\/GRAPHICS|\/GRESUME|\/GSAVE|\/GTYPE|HPGL|\/IMAGE|IMMED|JPEG|\/MREP|\/NOERASE|\/PCOPY|PNGR|PSCR|\/PSTATUS|\/REPLOT|\/RESET|\/SEG|\/SHOW|TIFF|\/WINDOW|\/ANGLE|\/AUTO|\/DIST|\/FOCUS|\/USER|\/VCONE|\/VIEW|\/VUP|\/XFRM|\/ZOOM|\/DSCALE|\/ICLWID|\/ICSCALE|\/RATIO|\/SHRINK|\/SSCALE|\/TXTRE|\/VSCALE|\/CPLANE|\/CTYPE|\/EDGE|\/ESHAPE|\/FACET|\/GLINE|\/GMARKER|GMFACE|\/LIGHT|\/NORMAL|\/SHADE|\/TRLCY|\/TYPE|\/CFORMAT|\/CLABEL|\/CONTOUR|\/CVAL|\/GFORMAT|\/HBC|\/NUMBER|\/PBC|\/PBF|PGSELE|\/PICE|\/PLOPTS|\/PNUM|\/PSF|\/PSYMB|\/TRIAD|\/UDOC|\/AXLAB|\/GRID|\/GROPT|\/GRTYP|\/GTHK|\/XRANGE|\/YRANGE|\/AN3D|\/ANNOT|\/ANUM|\/LARC|\/LINE|\/LSPEC|\/LSYMBOL|\/PCIRCLE|\/PMORE|\/POLYGON|\/PSPEC|\/PWEDGE|\/TLABEL|\/TSPEC)\b/.exec(this.str)) && this.hl(m[0], 'dsFunction')) continue;
...
HL.prototype._functions = function() {
    var m;
    while(this.pos < this.len) {
...
HL.prototype._open_parentesis = function() {
    var m;
    while(this.pos < this.len) {
...
HL.prototype._functions_arg = function() {
    var m;
    while(this.pos < this.len) {
