KateSyntax.langs.ruby.syntax = {
    ...
    ruby_normal: function ruby_normal(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^(?:$stdout|$defout|$stderr|$deferr|$stdin)\b/.exec(this.str)) && this.hl(m[0], 'dsDataType;color:#C00000;fontWeight:bold')) {if(m = this.ruby_check_div_2())return this.pop(), m-1;continue;}
            ...
            if((m = /^\$[\d_*`+@;,.~=\!\$:?'/\\\-\&"><]/.exec(this.str)) && this.hl(m[0], 'dsDataType;color:#C00000;fontWeight:bold')) {if(m = this.ruby_check_div_1())return this.pop(), m-1;continue;}
            if((m = /^\b[_A-Z]+[A-Z_0-9]+\b/.exec(this.str)) && this.hl(m[0], 'dsDataType;color:#bb1188;fontWeight:bold')) {if(m = this.ruby_check_div_2())return this.pop(), m-1;continue;}
