KateSyntax.langs['literate-haskell'].syntax = {
    default: 'literate-haskell_text',
    'literate-haskell_text': function literatehaskell_text(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.col === 0 && this.str[0] == '>' && this.hl('>', 'dsOthers')) {if(m = this['literate-haskell_normal']())return this.pop(), m-1;continue;}
            if(this.col === 0 && this.str[0] == '<' && this.hl('<', 'dsOthers')) {if(m = this['literate-haskell_normal']())return this.pop(), m-1;continue;}
            if((m = /^\\begin\{code\}/.exec(this.str)) && this.hl(m[0], 'dsNormal')) {if(m = this['literate-haskell_normals']())return this.pop(), m-1;continue;}
            if((m = /^\\begin\{spec\}/.exec(this.str)) && this.hl(m[0], 'dsNormal')) {if(m = this['literate-haskell_normals']())return this.pop(), m-1;continue;}
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
    'literate-haskell_normal': function literatehaskell_normal(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\{-[^#]/.exec(this.str)) && this.hl(m[0], 'dsComment')) {if(m = this['literate-haskell_comments'']())return this.pop(), m-1;continue;}
    ...
    'literate-haskell_normals': function literatehaskell_normals(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\end\{code\}/.exec(this.str)) && this.hl(m[0], 'dsNormal')) return this.pop();
            if((m = /^\\end\{spec\}/.exec(this.str)) && this.hl(m[0], 'dsNormal')) return this.pop();
            if((m = /^\{-#.*#-\}/.exec(this.str)) && this.hl(m[0], 'dsOthers')) continue;
            if((m = /^\{-[^#]?/.exec(this.str)) && this.hl(m[0], 'dsComment')) {if(m = this.haskell_comments())return this.pop(), m-1;continue;}
            if((m = /^--[^\-!#\$%&\*\+/<=>\?\@\^\|~\.:].*(?=$|\n)/.exec(this.str)) && this.hl(m[0], 'dsComment')) {if(m = this.haskell_comment())return this.pop(), m-1;continue;}
            if((m = /^(?:as|case|class|data|deriving|do|else|hiding|if|import|in|infixl|infixr|instance|let|module|newtype|of|primitive|qualified|then|type|where)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) continue;
    ...
    'literate-haskell_comments'': function literatehaskell_comments(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '-' && this.str[1] == '}' && this.hl('-}', 'dsComment')) return this.pop();
            if(this.str[0] == '\n') return this.pop(), this['literate-haskell_uncomments']();
            this.hl(this.str[0], 'dsComment');
        }
        this.pop();
    },
    'literate-haskell_uncomments': function literatehaskell_uncomments(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.col === 0 && this.str[0] == '>' && this.hl('>', 'dsOthers')) {if(m = this['literate-haskell_recomments']())return this.pop(), m-1;continue;}
            if(this.col === 0 && this.str[0] == '<' && this.hl('<', 'dsOthers')) {if(m = this['literate-haskell_recomments']())return this.pop(), m-1;continue;}
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
    'literate-haskell_recomments': function literatehaskell_recomments(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '-' && this.str[1] == '}' && this.hl('-}', 'dsComment')) return this.pop(), 2;
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsComment');
        }
        this.pop();
