KateSyntax.langs.xslt.syntax = {
    ...
    xslt_normalText: function xslt_normalText(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^<!\[CDATA\[/.exec(this.str)) && this.hl(m[0], 'dsBaseN;font-weight:bold')) {if(m = this.xslt_cDATA())return this.pop(), m-1;continue;}
            if((m = /^<!DOCTYPE\s+/.exec(this.str)) && this.hl(m[0], 'dsDataType;font-weight:bold')) {if(m = this.xslt_doctype())return this.pop(), m-1;continue;}
    ...
    xslt_doctype: function xslt_doctype(m) {
        ...
        while(this.pos < this.len) {
            ...
            if(this.str[0] == '[' && this.hl('[', 'dsDataType;font-weight:bold')) {if(m = this.xslt_doctypeInternalSubset())return this.pop(), m-1;continue;}
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
    xslt_doctypeInternalSubset: function xslt_doctypeInternalSubset(m) {
        ...
        while(this.pos < this.len) {
            if(this.str[0] == ']' && this.hl(']', 'dsDataType;font-weight:bold')) return this.pop();
            if((m = /^<!(ELEMENT|ENTITY|ATTLIST|NOTATION)\b/.exec(this.str)) && this.hl(m[0], 'dsDataType;font-weight:bold')) {if(m = this.xslt_doctypeMarkupdecl())return this.pop(), m-1;continue;}
            if((m = /^<!--/.exec(this.str)) && this.hl(m[0], 'dsComment')) {if(m = this.xslt_comment())return this.pop(), m-1;continue;}
            if((m = /^<\?[\w:_-]*/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) {if(m = this.xslt_pI())return this.pop(), m-1;continue;}
            if((m = /^&entref;/.exec(this.str)) && this.hl(m[0], 'dsDecVal')) continue;
    ...
    xslt_attrValue: function xslt_attrValue(m) {
        ...
        while(this.pos < this.len) {
            ...
            if(this.str[0] == '"' && this.hl('"', 'dsString;color:#800000;font-style:normal;font-weight:normal')) {if(m = this.xslt_string())return this.pop(), m-1;continue;}
            if(this.str[0] == '\'' && this.hl('\'', 'dsString;color:#800000;font-style:normal;font-weight:normal')) {if(m = this.xslt_sqstring())return this.pop(), m-1;continue;}
    ...
    xslt_xattrValue: function xslt_xattrValue(m) {
        ...
        while(this.pos < this.len) {
            if(this.str[0] == '/' && this.str[1] == '>' && this.hl('/>', 'dsError')) return this.pop(), 2;
            if(this.str[0] == '>' && this.hl('>', 'dsError')) return this.pop(), 2;
            if(this.str[0] == '"' && this.hl('"', 'dsOthers;color:#008080;font-style:normal;font-weight:normal')) {if(m = this.xslt_xpath())return this.pop(), m-1;continue;}
            if(this.str[0] == '\'' && this.hl('\'', 'dsOthers;color:#008080;font-style:normal;font-weight:normal')) {if(m = this.xslt_sqxpath())return this.pop(), m-1;continue;}
            this.hl(this.str[0], 'dsError');
        }
        this.pop();
    },
    ...
    xslt_xpath: function xslt_xpath(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^(&axisname;)::/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#008080;font-style:italic;font-weight:normal')) continue;
            if(this.str[0] == '}' && this.hl('}', 'dsOthers;color:#008080;font-style:normal;font-weight:normal')) return this.pop();
            if(this.str[0] == '\'' && this.hl('\'', 'dsString;color:#800000;font-style:normal;font-weight:normal')) {if(m = this.xslt_sqxpathstring())return this.pop(), m-1;continue;}
            if(this.str[0] == '"' && this.hl('"', 'dsOthers;color:#008080;font-style:normal;font-weight:normal')) return this.pop(), 1;
            if((m = /^@&qname;/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#008080;font-style:italic;font-weight:normal')) continue;
            if((m = /^\$&qname;/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#008080;font-style:italic;font-weight:normal')) continue;
            if((m = /^&qname;/.exec(this.str)) && this.hl(m[0], 'dsOthers;color:#008080;font-style:normal;font-weight:normal')) continue;
            if(this.str[0] == '$' && this.hl('$', 'dsError')) continue;
            if((m = /^&entref;/.exec(this.str)) && this.hl(m[0], 'dsDecVal')) continue;
            this.hl(this.str[0], 'dsOthers;color:#008080;font-style:normal;font-weight:normal');
        }
        this.pop();
    },
    xslt_sqxpath: function xslt_sqxpath(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^(&axisname;)::/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#008080;font-style:italic;font-weight:normal')) continue;
            if(this.str[0] == '}' && this.hl('}', 'dsOthers;color:#008080;font-style:normal;font-weight:normal')) return this.pop();
            if(this.str[0] == '"' && this.hl('"', 'dsString;color:#800000;font-style:normal;font-weight:normal')) {if(m = this.xslt_xpathstring())return this.pop(), m-1;continue;}
            if(this.str[0] == '\'' && this.hl('\'', 'dsOthers;color:#008080;font-style:normal;font-weight:normal')) return this.pop(), 1;
            if((m = /^@&qname;/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#008080;font-style:italic;font-weight:normal')) continue;
            if((m = /^\$&qname;/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#008080;font-style:italic;font-weight:normal')) continue;
            if((m = /^&qname;/.exec(this.str)) && this.hl(m[0], 'dsOthers;color:#008080;font-style:normal;font-weight:normal')) continue;
    ...
    xslt_sqxpathstring: function xslt_sqxpathstring(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '\'' && this.hl('\'', 'dsString;color:#800000;font-style:normal;font-weight:normal')) return this.pop();
            if((m = /^&entref;/.exec(this.str)) && this.hl(m[0], 'dsDecVal')) continue;
            this.hl(this.str[0], 'dsString;color:#800000;font-style:normal;font-weight:normal');
        }
        this.pop();
