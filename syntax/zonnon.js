KateSyntax.langs.zonnon.syntax = {
    ...
    zonnon_normal: function zonnon_normal(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^(?:abs|assert|cap|copy|copyvalue|dec|excl|false|halt|inc|len|low|max|min|odd|pred|read|readln|reason|size|succ|true|write|writeln)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword;fontStyle:italic')) continue;
