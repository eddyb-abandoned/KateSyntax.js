KateSyntax.langs.idl.syntax = {
    default: 'idl_normal',
    idl_normal: function idl_normal(m) {
        this.push();
        while(this.pos < this.len) {
            ...
            if(this.str[0] == '"' && this.hl('"', 'dsString')) {if(m = this.idl_string())return this.pop(), m-1;continue;}
            ...
            if((m = /^\/\*\s*@\}\s*\*\//.exec(this.str)) && this.hl(m[0], 'dsRegionMarker')) continue;
            if(this.str[0] == '/' && this.str[1] == '/' && this.hl('//', 'dsComment')) {if(m = this.idl_commentar1())return this.pop(), m-1;continue;}
            if(this.str[0] == '/' && this.str[1] == '*' && this.hl('/*', 'dsComment')) {if(m = this.idl_commentar2())return this.pop(), m-1;continue;}
            if((m = /^[!%&()+,\-<=>?[\]\^{|}~]/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            if((m = /^#if 0/.exec(this.str)) && this.hl(m[0], 'dsComment')) {if(m = this.idl_someContext3())return this.pop(), m-1;continue;}
            if(this.col === 0 && this.str[0] == '#' && this.hl('#', 'dsOthers')) {if(m = this.idl_preprocessor())return this.pop(), m-1;continue;}
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
    idl_string: function idl_string(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsString')) {if(m = this.idl_someContext())return this.pop(), m-1;continue;}
    ...
    idl_commentar1: function idl_commentar1(m) {
        this.push();
        while(this.pos < this.len) {
    ...
    idl_commentar2: function idl_commentar2(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^(FIXME|TODO)/.exec(this.str)) && this.hl(m[0], 'dsAlert')) continue;
    ...
    idl_preprocessor: function idl_preprocessor(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsOthers')) {if(m = this.idl_someContext2())return this.pop(), m-1;continue;}
            if((m = /^".*?"/.exec(this.str)) && this.hl(m[0], 'dsOthers')) continue;
            if((m = /^<.*?>/.exec(this.str)) && this.hl(m[0], 'dsOthers')) continue;
            if(this.str[0] == '/' && this.str[1] == '/' && this.hl('//', 'dsComment')) {if(m = this.idl_commentar1())return this.pop(), m-1;continue;}
            if(this.str[0] == '/' && this.str[1] == '*' && this.hl('/*', 'dsComment')) {if(m = this.idl_commentarPreprocessor())return this.pop(), m-1;continue;}
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsOthers');
        }
        this.pop();
    },
    idl_commentarPreprocessor: function idl_commentarPreprocessor(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '*' && this.str[1] == '/' && this.hl('*/', 'dsComment')) return this.pop();
            this.hl(this.str[0], 'dsComment');
    ...
    idl_someContext: function idl_someContext(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsNormal');
    ...
    idl_someContext2: function idl_someContext2(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsNormal');
    ...
    idl_someContext3: function idl_someContext3(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^(FIXME|TODO)/.exec(this.str)) && this.hl(m[0], 'dsAlert')) continue;
