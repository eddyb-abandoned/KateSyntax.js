KateSyntax.langs.djangotemplate.syntax = {
    ...
    djangotemplate_start: function djangotemplate_start(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^<!\[CDATA\[/.exec(this.str)) && this.hl(m[0], 'dsBaseN;fontWeight:bold')) {if(m = this.djangotemplate_cDATA())return this.pop(), m-1;continue;}
            if((m = /^<!DOCTYPE\s+/.exec(this.str)) && this.hl(m[0], 'dsDataType;fontWeight:bold')) {if(m = this.djangotemplate_doctype())return this.pop(), m-1;continue;}
            ...
            if((m = /^<!(ELEMENT|ENTITY|ATTLIST|NOTATION)\b/.exec(this.str)) && this.hl(m[0], 'dsDataType;fontWeight:bold')) {if(m = this.djangotemplate_doctypeMarkupdecl())return this.pop(), m-1;continue;}
    ...
    djangotemplate_doctype: function djangotemplate_doctype(m) {
        ...
        while(this.pos < this.len) {
            ...
            if(this.str[0] == '[' && this.hl('[', 'dsDataType;fontWeight:bold')) {if(m = this.djangotemplate_doctypeInternalSubset())return this.pop(), m-1;continue;}
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
