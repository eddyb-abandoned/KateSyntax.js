KateSyntax.langs.python.syntax = {
    ...
    python_normal: function python_normal(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^(?:and|in|is|not|or)\b/.exec(this.str)) && this.hl(m[0], 'dsNormal;fontWeight:bold')) continue;
            ...
            if((m = /^@[_a-zA-Z][\._a-zA-Z0-9]*/.exec(this.str)) && this.hl(m[0], 'dsOthers;color:#8f6b32;fontStyle:normal')) continue;
