KateSyntax.langs.povray.syntax = {
    ...
    povray_normal: function povray_normal(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^(?:#debug|#default|#else|#end|#error|#fclose|#fopen|#if|#ifdef|#ifndef|#include|#range|#read|#render|#statistics|#switch|#undef|#version|#warning|#while|#write)\b/.exec(this.str)) && this.hl(m[0], 'dsOthers;color:#3300ff;fontStyle:normal;fontWeight:bold')) continue;
            ...
            if((m = /^(?:akima_spline|aoi|basic_x_spline|camera_view|displace|exposure|exposure_gain|extended_x_spline|float|frame_step|date|start_chrono|current_chrono|general_x_spline|glow|h_align_left|h_align_right|h_align_center|v_align_top|v_align_bottom|v_align_center|inverted_normals|is|listed|mpeg|n_roots|noise_pigment|output_filename|post_process|projection|point|blur|set|sor_spline|string|structure|tcb_spline|tension|continuity|bias|user_defined|vector|unofficial_version|gravity|environment|friction|damping|simcloth|wind|neighbors|neighbours|internal_collision|viscosity|iterations|input|mesh_output|smooth_mesh|uv_mesh|output|stiffness|topology|mass|connection|face|velocity|position|mass_count|connection_count|face_count|index1|index2|index3|time|time_step|step_count|start_time|end_time|fixed|collision|interaction|group|attach|field|mechsim|bounding|viscoelastic|viscoelastic_count|element|length|force|message|weight|randomize|hdr|no_radiosity|motion_blur|tone_mapping|show_samples|show_low_count)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#0080d0;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^\d*\.\d+/.exec(this.str)) && this.hl(m[0], 'dsFloat;color:#0000ff;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^\d+/.exec(this.str)) && this.hl(m[0], 'dsFloat;color:#0000ff;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^'(\\([abefnrtv"'?\\]|x[\da-fA-F]{2}|0?[0-7]{1,2})|[^\a\b\e\f\n\r\t\v])'/.exec(this.str)) && this.hl(m[0], 'dsChar;color:#000080;fontStyle:normal;fontWeight:normal')) continue;
            if(this.str[0] == '"' && this.hl('"', 'dsString;color:#ff0000;fontStyle:normal;fontWeight:normal')) {if(m = this.povray_string())return this.pop(), m-1;continue;}
            if((m = /^\/\/\s*BEGIN.*(?=$|\n)/.exec(this.str)) && this.hl(m[0], 'dsRegionMarker')) continue;
            if((m = /^\/\/\s*END.*(?=$|\n)/.exec(this.str)) && this.hl(m[0], 'dsRegionMarker')) continue;
            if(this.str[0] == '/' && this.str[1] == '/' && this.hl('//', 'dsComment;color:#008000;fontStyle:normal;fontWeight:normal')) {if(m = this.povray_commentar1())return this.pop(), m-1;continue;}
            if(this.str[0] == '/' && this.str[1] == '*' && this.hl('/*', 'dsComment;color:#008000;fontStyle:normal;fontWeight:normal')) {if(m = this.povray_commentar2())return this.pop(), m-1;continue;}
            if(this.str[0] == '{' && this.hl('{', 'dsNormal;color:#660099;fontStyle:normal;fontWeight:normal')) continue;
            if(this.str[0] == '}' && this.hl('}', 'dsNormal;color:#660099;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^[:!%&()+,\-/.*<=>?[\]{|}~\^;]/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#660099;fontStyle:normal;fontWeight:normal')) continue;
            this.hl(this.str[0], 'dsNormal;color:#000000;fontStyle:normal;fontWeight:normal');
        }
        this.pop();
    },
    povray_declaration: function povray_declaration(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\w+/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#990099;fontStyle:normal;fontWeight:bold')) {if(m = this.povray_declare_Keyword())return this.pop(), m-1;continue;}
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000080;fontStyle:normal;fontWeight:bold')) continue;
            if((m = /^[=[(]/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#660099;fontStyle:normal;fontWeight:normal')) return this.pop(), 1;
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsKeyword;color:#000080;fontStyle:normal;fontWeight:bold');
        }
        this.pop();
    },
    povray_macro: function povray_macro(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\w+/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#CC0000;fontStyle:normal;fontWeight:bold')) {if(m = this.povray_declare_Macro())return this.pop(), m-1;continue;}
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000080;fontStyle:normal;fontWeight:bold')) continue;
            if(this.str[0] == '(' && this.hl('(', 'dsNormal;color:#660099;fontStyle:normal;fontWeight:normal')) return this.pop(), 1;
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsKeyword;color:#000080;fontStyle:normal;fontWeight:bold');
        }
        this.pop();
    },
    povray_declare_Keyword: function povray_declare_Keyword(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#990099;fontStyle:normal;fontWeight:bold')) continue;
            if((m = /^[=[(]/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#660099;fontStyle:normal;fontWeight:normal')) return this.pop(), 1;
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsKeyword;color:#990099;fontStyle:normal;fontWeight:bold');
        }
        this.pop();
    },
    povray_declare_Macro: function povray_declare_Macro(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#CC0000;fontStyle:normal;fontWeight:bold')) continue;
            if(this.str[0] == '(' && this.hl('(', 'dsNormal;color:#660099;fontStyle:normal;fontWeight:normal')) return this.pop(), 1;
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsKeyword;color:#CC0000;fontStyle:normal;fontWeight:bold');
        }
        this.pop();
    },
    povray_string: function povray_string(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsString;color:#ff0000;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^\\([abefnrtv"'?\\]|x[\da-fA-F]{2}|0?[0-7]{1,2})/.exec(this.str)) && this.hl(m[0], 'dsChar;color:#ff00ff;fontStyle:normal;fontWeight:normal')) continue;
            if(this.str[0] == '"' && this.hl('"', 'dsString;color:#ff0000;fontStyle:normal;fontWeight:normal')) return this.pop();
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsString;color:#ff0000;fontStyle:normal;fontWeight:normal');
        }
        this.pop();
    },
    povray_commentar1: function povray_commentar1(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^(?:FIXME|TODO|###)\b/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#008000;fontStyle:normal;fontWeight:normal')) continue;
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsComment;color:#008000;fontStyle:normal;fontWeight:normal');
        }
        this.pop();
    },
    povray_commentar2: function povray_commentar2(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^(?:FIXME|TODO|###)\b/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#008000;fontStyle:normal;fontWeight:normal')) continue;
            if(this.str[0] == '*' && this.str[1] == '/' && this.hl('*/', 'dsComment;color:#008000;fontStyle:normal;fontWeight:normal')) return this.pop();
            this.hl(this.str[0], 'dsComment;color:#008000;fontStyle:normal;fontWeight:normal');
        }
        this.pop();
    },
    povray_commentar: function povray_commentar(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '*' && this.str[1] == '/' && this.hl('*/', 'dsComment;color:#008000;fontStyle:normal;fontWeight:normal')) return this.pop();
            this.hl(this.str[0], 'dsComment;color:#008000;fontStyle:normal;fontWeight:normal');
