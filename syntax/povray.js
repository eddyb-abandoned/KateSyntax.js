KateSyntax.langs.povray.syntax = {
    ...
    povray_normal: function povray_normal(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^(?:#debug|#default|#else|#end|#error|#fclose|#fopen|#if|#ifdef|#ifndef|#include|#range|#read|#render|#statistics|#switch|#undef|#version|#warning|#while|#write)\b/.exec(this.str)) && this.hl(m[0], 'dsOthers;color:#3300ff;font-style:normal;font-weight:bold')) continue;
    ...
    povray_declaration: function povray_declaration(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\w+/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#990099;font-style:normal;font-weight:bold')) {if(m = this.povray_declare_Keyword())return this.pop(), m-1;continue;}
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000080;font-style:normal;font-weight:bold')) continue;
            if((m = /^[=[(]/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#660099;font-style:normal;font-weight:normal')) return this.pop(), 1;
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsKeyword;color:#000080;font-style:normal;font-weight:bold');
        }
        this.pop();
    },
    povray_macro: function povray_macro(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\w+/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#CC0000;font-style:normal;font-weight:bold')) {if(m = this.povray_declare_Macro())return this.pop(), m-1;continue;}
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000080;font-style:normal;font-weight:bold')) continue;
            if(this.str[0] == '(' && this.hl('(', 'dsNormal;color:#660099;font-style:normal;font-weight:normal')) return this.pop(), 1;
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsKeyword;color:#000080;font-style:normal;font-weight:bold');
        }
        this.pop();
    ...
    povray_declare_Keyword: function povray_declare_Keyword(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#990099;font-style:normal;font-weight:bold')) continue;
            if((m = /^[=[(]/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#660099;font-style:normal;font-weight:normal')) return this.pop(), 1;
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsKeyword;color:#990099;font-style:normal;font-weight:bold');
        }
        this.pop();
    },
    povray_declare_Macro: function povray_declare_Macro(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#CC0000;font-style:normal;font-weight:bold')) continue;
            if(this.str[0] == '(' && this.hl('(', 'dsNormal;color:#660099;font-style:normal;font-weight:normal')) return this.pop(), 1;
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsKeyword;color:#CC0000;font-style:normal;font-weight:bold');
        }
        this.pop();
    },
    povray_string: function povray_string(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^\\([abefnrtv"'?\\]|x[\da-fA-F]{2}|0?[0-7]{1,2})/.exec(this.str)) && this.hl(m[0], 'dsChar;color:#ff00ff;font-style:normal;font-weight:normal')) continue;
            if(this.str[0] == '"' && this.hl('"', 'dsString;color:#ff0000;font-style:normal;font-weight:normal')) return this.pop();
            if(this.str[0] == '\n') return this.pop();
    ...
    povray_commentar1: function povray_commentar1(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^(?:FIXME|TODO|###)\b/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#008000;font-style:normal;font-weight:normal')) continue;
            if(this.str[0] == '\n') return this.pop();
    ...
    povray_commentar2: function povray_commentar2(m) {
        ...
        while(this.pos < this.len) {
            if((m = /^(?:FIXME|TODO|###)\b/.exec(this.str)) && this.hl(m[0], 'dsComment;color:#008000;font-style:normal;font-weight:normal')) continue;
            if(this.str[0] == '*' && this.str[1] == '/' && this.hl('*/', 'dsComment;color:#008000;font-style:normal;font-weight:normal')) return this.pop();
            this.hl(this.str[0], 'dsComment;color:#008000;font-style:normal;font-weight:normal');
        }
        this.pop();
    },
