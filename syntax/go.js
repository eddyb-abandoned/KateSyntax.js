KateSyntax.langs.go.syntax = {
    default: 'go_normal',
    go_normal: function go_normal(m) {
        this.push();
        while(this.pos < this.len) {
            ...
            if(this.str[0] == '}' && this.hl('}', 'dsNormal')) continue;
            if(this.str[0] == '/' && this.str[1] == '/' && this.hl('//', 'dsComment')) {if(m = this.go_commentar1())return this.pop(), m-1;continue;}
            if(this.str[0] == '/' && this.str[1] == '*' && this.hl('/*', 'dsComment')) {if(m = this.go_commentar2())return this.pop(), m-1;continue;}
            ...
            if(this.str[0] == '"' && this.hl('"', 'dsString')) {if(m = this.go_string())return this.pop(), m-1;continue;}
            if(this.str[0] == '`' && this.hl('`', 'dsNormal')) {if(m = this.go_multilineString())return this.pop(), m-1;continue;}
            if((m = /^[:!%&()+,\-/.*<=>?[\]|~\^;]/.exec(this.str)) && this.hl(m[0], 'dsNormal')) continue;
            this.hl(this.str[0], 'dsNormal');
        }
        this.pop();
    },
    go_commentar1: function go_commentar1(m) {
        this.push();
        while(this.pos < this.len) {
    ...
    go_commentar2: function go_commentar2(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^[^\S\n]+/.exec(this.str)) && this.hl(m[0], 'dsComment')) continue;
    ...
    go_string: function go_string(m) {
        this.push();
        while(this.pos < this.len) {
    ...
    go_multilineString: function go_multilineString(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^\\\n/.exec(this.str)) && this.hl(m[0], 'dsString')) continue;
            if((m = /^\\([abefnrtv"'?\\]|x[\da-fA-F]{2}|0?[0-7]{1,2})/.exec(this.str)) && this.hl(m[0], 'dsChar')) continue;
