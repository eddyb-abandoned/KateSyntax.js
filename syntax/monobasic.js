KateSyntax.langs.monobasic.syntax = {
    ...
    monobasic_normal: function monobasic_normal(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^\b(Namespace)([\s]|(?=$|\n))/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000080;fontWeight:normal')) continue;
            if((m = /^End.Namespace.*(?=$|\n)/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000080;fontWeight:normal')) continue;
            if((m = /^\b(Module)([\s]|(?=$|\n))/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000080;fontWeight:normal')) continue;
            if((m = /^End.Module.*(?=$|\n)/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000080;fontWeight:normal')) continue;
            if((m = /^\b(Class)([\s]|(?=$|\n))/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#000080;fontWeight:normal')) continue;
