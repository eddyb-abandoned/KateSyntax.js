KateSyntax.langs.metafont.syntax = {
    ...
    metafont_normalText: function metafont_normalText(m) {
        ...
        while(this.pos < this.len) {
            if((m = /^(?:true|false|known|unknown|odd|charexists|not|and|or)\b/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#AA00AA;fontStyle:italic;fontWeight:normal')) continue;
            ...
            if((m = /^(?:tracingtitles|tracingequations|tracingcapsules|tracingchoices|tracingspecs|tracingpens|tracingcommands|tracingrestores|tracingmacros|tracingedges|tracingoutput|tracingonline|tracingstats|pausing|showstopping|fontmaking|proofing|turningcheck|warningcheck|smoothing|autorounding|granularity|fillin|year|month|day|time|charcode|charext|charwd|charht|chardp|charic|chardx|chardy|designsize|hppp|vppp|xoffset|yoffset|boundarychar)\b/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#0000FF;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^(?:point|of|precontrol|postcontrol|penoffset|rotated|scaled|shifted|slanted|transformed|xscaled|yscaled|zscaled)\b/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#0000FF;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^(?:makepath|reverse|subpath|curl|tension|atleast|controls|cycle)\b/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#0000FF;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^(?:nullpen|pencircle|makepen)\b/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#0000FF;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^(?:nullpicture)\b/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#0000FF;fontStyle:normal;fontWeight:normal')) continue;
            if((m = /^(?:jobname|readstring|str|char|decimal|substring)\b/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#0000FF;fontStyle:normal;fontWeight:normal')) continue;
            ...
            if((m = /^(\+|\-|\*|\/|\=|\:\=)/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#244CFF;fontWeight:normal')) continue;
            if(this.str[0] == '.' && this.str[1] == '.' && this.hl('..', 'dsKeyword;color:#244CFF;fontWeight:normal')) continue;
            ...
            if(this.str[0] == '$' && this.hl('$', 'dsKeyword;color:#008000;fontWeight:normal')) continue;
    ...
    metafont_teXMode: function metafont_teXMode(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '\\' && this.hl('\\', 'dsNormal;color:#800000;fontStyle:normal;fontWeight:normal')) {if(m = this.metafont_contrSeq())return this.pop(), m-1;continue;}
            if(this.str[0] == '$' && this.hl('$', 'dsNormal;color:#00A000;fontStyle:normal;fontWeight:normal')) {if(m = this.metafont_mathMode())return this.pop(), m-1;continue;}
            if((m = /^\\\(/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#00A000;fontStyle:normal;fontWeight:normal')) {if(m = this.metafont_mathMode())return this.pop(), m-1;continue;}
    ...
    metafont_contrSeq: function metafont_contrSeq(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^verb\*/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#800000;fontStyle:normal;fontWeight:normal')) {if(m = this.metafont_verb())return this.pop(), m-1;continue;}
            if((m = /^verb(?=[^a-zA-Z])/.exec(this.str)) && this.hl(m[0], 'dsNormal;color:#800000;fontStyle:normal;fontWeight:normal')) {if(m = this.metafont_verb())return this.pop(), m-1;continue;}
            if(this.str[0] == '×' && this.hl('×', 'dsNormal;color:#800000;fontStyle:normal;fontWeight:normal')) continue;
    ...
    metafont_mathMode: function metafont_mathMode(m) {
        ...
        while(this.pos < this.len) {
            ...
            if(this.str[0] == '\\' && this.hl('\\', 'dsNormal;color:#606000;fontStyle:normal;fontWeight:normal')) {if(m = this.metafont_mathContrSeq())return this.pop(), m-1;continue;}
    ...
    metafont_mathContrSeq: function metafont_mathContrSeq(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '×' && this.hl('×', 'dsNormal;color:#606000;fontStyle:normal;fontWeight:normal')) continue;
