KateSyntax.langs.gdb.syntax = {
    ...
    gdb_apache: function gdb_apache(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^\[KCrash Handler]/.exec(this.str)) && this.hl(m[0], 'dsError;font-weight:bold;text-decoration:none')) continue;
    ...
    gdb_identifier: function gdb_identifier(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^%2/.exec(this.str)) && this.hl(m[0], 'dsFunction;font-weight:bold')) continue;
            if((m = /^\b0x0\b/.exec(this.str)) && this.hl(m[0], 'dsError;font-weight:bold;text-decoration:none')) continue;
