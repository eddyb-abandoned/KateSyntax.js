KateSyntax.langs.asp.syntax = {
    ...
    asp_nosource: function asp_nosource(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^<\s*script\s*language="VBScript"[^>]*>/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#0F0000;font-style:normal;font-weight:bold')) {if(m = this.asp_aspsource())return this.pop(), m-1;continue;}
            if((m = /^<\s*script(\s|>)/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#0F0000;font-style:normal;font-weight:bold')) {if(m = this.asp_scripts())return this.pop(), m-1;continue;}
            if((m = /^<\s*\/?\s*[a-zA-Z_:][a-zA-Z0-9._:-]*/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#0F0000;font-style:normal;font-weight:bold')) {if(m = this.asp_htmltag())return this.pop(), m-1;continue;}
    ...
    asp_aspsource: function asp_aspsource(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^<\s*\/\s*script\s*>/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#0F0000;font-style:normal;font-weight:bold')) return this.pop();
            ...
            if((m = /^\belseif\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\belse\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bif\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bend if\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            ...
            if((m = /^\bexit do\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bdo(\s+(while))?\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bloop\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bexit while\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bwhile\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bwend\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bexit for\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bfor\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bnext\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bselect case\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
            if((m = /^\bend select\b/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#A1A100;font-style:normal;font-weight:normal')) continue;
    ...
    asp_doublequotestring: function asp_doublequotestring(m) {
        ...
        while(this.pos < this.len) {
            ...
            if((m = /^\\[0-7]{1,3}/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#0F0F8F;font-style:normal;font-weight:bold')) continue;
            if((m = /^\\x[0-9A-Fa-f]{1,2}/.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#0F0F8F;font-style:normal;font-weight:bold')) continue;
    ...
    asp_htmltag: function asp_htmltag(m) {
        this.push();
        while(this.pos < this.len) {
            if(this.str[0] == '/' && this.str[1] == '>' && this.hl('/>', 'dsKeyword;color:#0F0000;font-style:normal;font-weight:bold')) return this.pop();
            if(this.str[0] == '>' && this.hl('>', 'dsKeyword;color:#0F0000;font-style:normal;font-weight:bold')) return this.pop();
            if((m = /^<%/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) {if(m = this.asp_aspsource())return this.pop(), m-1;continue;}
            if((m = /^<%/.exec(this.str)) && this.hl(m[0], 'dsKeyword')) {if(m = this.asp_aspsource())return this.pop(), m-1;continue;}
    ...
    asp_scripts_onelinecomment: function asp_scripts_onelinecomment(m) {
        this.push();
        while(this.pos < this.len) {
            if((m = /^<\s*\/\s*script\s*>/i.exec(this.str)) && this.hl(m[0], 'dsKeyword;color:#0F0000;font-style:normal;font-weight:bold')) return this.pop(), 1;
            if(this.str[0] == '\n') return this.pop();
            this.hl(this.str[0], 'dsComment');
        }
        this.pop();
