...
HL.prototype._normalText = function() {
    ...
    while(this.pos < this.len) {
        ...
        if((m = /^\w+\s*(?=\()/.exec(this.str)) && this.hl(m[0], 'dsFunction')) {this._macroArgs();continue;}
        this.hl(this.str[0], 'dsNormal');
    }
};
HL.prototype._detectVariables = function() {
    var m;
    while(this.pos < this.len) {
        if((m = /^\$ENV\{\s*\w+\s*\}/.exec(this.str)) && this.hl(m[0], 'dsFloat')) continue;
        if((m = /^\$\{\s*\w+\s*\}/.exec(this.str)) && this.hl(m[0], 'dsDecVal')) continue;
...
HL.prototype._commandArgs = function() {
    var m;
    while(this.pos < this.len) {
...
HL.prototype._macroArgs = function() {
    var m;
    while(this.pos < this.len) {
        if(this.str[0] == ')' && this.hl(')', 'dsNormal')) return;
        if((m = /^\\"/.exec(this.str)) && this.hl(m[0], 'dsChar')) continue;
